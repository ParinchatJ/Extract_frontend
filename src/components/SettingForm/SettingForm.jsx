            ...
            <div className='setting-forms'>
              <div id='info-container' >
                <div className='picture-name'>
                  {/* <SetProfilePic />
                  <div className="namenusertop">
                    <h2 id='name-top'>{user[0].name}</h2>
                    <h3 id='user-top'>{user[0].username}</h3>
                  </div> */}
                </div>
                <h2 className="headinfo">Personal Information</h2>
...
{
  /* <div className="cotainer-editprofile">
  <form onSubmit={handleSubmit(onSummit)}>
    <div className="usernpicprofile">
      <SetProfilePic />
      <div className="username-now">
        <h2 id="name-top">{user[0].name}</h2>
    ...
    <div className="informationform">
      ...
      <div className="personal-infomation-form">
        <input
          type="text"
        ...
        {errors.password && (
          <span>
            Passwaord shoud have uppercase, lowercase and number, and is at
        ...
        <div className="height-weight">
          ...
          {(errors.height || errors.weight) && (
            <span>Height and Weight are required</span>
          )}
        </div>
      </div>
    </div>
